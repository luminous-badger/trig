...
MsgText = 'Fractal for Cos( Z^2 ) ' + ' and rnum: ' + str( rnum )

draw = ImageDraw.Draw(img)
font = ImageFont.truetype( "/Library/Fonts/Arial.ttf", 12 )
draw.text( ( 0, 0 ),  MsgText, ( 139,0,0 ), font=font )

print 'Fractal for Cos( Z^2 ) ', C, 'and Rand:', rnum, 'created in %f s' % dt
print 'Calc: ', calc_count

fname = 'Cos_Zsq:' + str( X_MAX ) + str( X_MIN ) + '_Y:' + str( Y_MAX ) + str( Y_MIN ) + '.png'
print 'Fname:', fname
